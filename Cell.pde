class Cell {
  ...
  float range;      // How far is the cell from it's origin?
  ...
  xoff = dna.genes[22]; //Seed for noise
  yoff = dna.genes[23]; //Seed for noise
  ...
  void updatePosition() { //Update parameters linked to the position
    ...
    //PVector home = new PVector(dna.genes[18], dna.genes[19]); // home is where the heart is...
  ...
  void updateStripes() {
    fillColor = color(40, 255, 255); // RED
